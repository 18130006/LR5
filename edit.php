...
while ($rows=mysqli_fetch_array($result_2)){
        echo("Введите дату: <input id='date' type='date' name='date' value='".$rows['date']."'><br>");
        echo("Введите оценку: <input id='date' type='number' name='ocenka' min='2' max='5' value='".$rows['ocenka']."'><br>");
}
$id_0 = "stud_select";
